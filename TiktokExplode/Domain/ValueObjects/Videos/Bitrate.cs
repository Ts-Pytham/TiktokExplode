...
/// TikTok may return partial bitrate metadata depending on the source endpoint.
/// </summary>
public readonly record struct Bitrate
{
    ...
    /// <summary>
    /// The frames-per-second rate of this encoding variant, if TikTok provides it.
    /// </summary>
    ...
    /// <summary>
    /// The raw format string as returned by TikTok's API, if available
    /// (e.g. <c>"mp4"</c>, <c>"mp3"</c>).
